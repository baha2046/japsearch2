...
public interface SecurityPassthrough {
	 ...
	 * @param document - the document to examine. should already be downloaded with html of the target page you are trying to of
	...
	/**
	 * Given the passed in document, clicks any sort of captchas to of to the required page,
