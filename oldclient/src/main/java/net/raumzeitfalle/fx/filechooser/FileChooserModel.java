...
final class FileChooserModel {
     ...
     *
     * @param criterion {@link String} A search getLabel such as &quot;index&quot; for &quot;index.html&quot; or &quot;index.txt&quot;.
     */
    public void updateFilterCriterion(String criterion) {
        Predicate<IndexedPath> customFilter = this.createManualListFilter(criterion);
        this.filteredPaths.setPredicate(this.combineFilterPredicates(customFilter));
    }
    ...
    private Predicate<IndexedPath> createManualListFilter(String criterion) {
        String corrected = this.removeInvalidChars(criterion);
    ...
    public void changeToUsersHome() {
        this.updateFilesIn(getUsersHome());
    }
