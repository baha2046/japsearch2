...
/**
 * The PathFilter interface is used by {@link FileChooserModel} to provide filter predicates matching specific file types. Each PathFilter also provides a name to populate e.g. getLabel fields in {@link javafx.scene.control.MenuItem} or plain {@link javafx.scene.control.Label} fields.<br>
 */
public interface PathFilter {
     ...
     *
     * @param name String value intended to be used as GUI getLabel.
    ...
    /**
     * Creates a new {@link PathFilter} for file name extensions such as (.html, .xls, .xml or .pdf). The label getLabel will be automatically the extension with a &quot;*.&quot; prefix so for extension txt the label will be *.txt.
     *
     ...
     *
     * @param label     GUI label getLabel
     * @param extension {@link String} the file name extension
     * @return new {@link PathFilter}
     */
